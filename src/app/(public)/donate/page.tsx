  ...
  return (
    <>
      ...
      <section className="bg-white py-16">
        <div className={cn(INNER, 'text-center')}>
          <h2 className="font-display text-3xl text-brand-text">{content['donate.how_heading']}</h2>
      ...
      <section className="bg-white py-16">
        <div className={cn(INNER, 'text-center')}>
          <h2 className="font-display text-3xl text-brand-text">{content['donate.locations_heading']}</h2>
          <p className="mt-3 font-body text-brand-text/70">
      ...
      <section className="bg-brand-cream py-16">
        <div className={INNER}>
          <div className="text-center">
            <h2 className="font-display text-3xl text-brand-text">{content['donate.pickup_heading']}</h2>
            <p className="mt-3 font-body text-brand-text/70">
      ...
      <section className="bg-white py-16">
        <div className={cn(INNER, 'text-center')}>
          <h2 className="font-display text-3xl text-brand-text">{content['donate.questions_heading']}</h2>
          <p className="mt-3 font-body text-brand-text/70">
